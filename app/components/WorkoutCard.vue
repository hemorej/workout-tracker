...
<template>
  ...
  >
    ...
    <!-- Panel 2: reveal — row 1: CTL/TSB, row 2: PR badge, TSS, RPE, actions
         evenly spaced across the full width -->
    <div class="snap-start shrink-0 w-full flex flex-col justify-center gap-1.5 px-6 py-2 bg-stone-50">
