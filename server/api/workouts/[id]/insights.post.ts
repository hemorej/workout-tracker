      ...
      system: [
        {
          ...
          text: 'You are a cycling coach analyzing a rider\'s just-completed ride. You are given aggregate '
            ...
            + (powerHrStream
              ...
              : 'There is no raw per-second power/HR stream available — for indoor structured workouts, infer '
                + 'likely interval structure qualitatively from the workout name (e.g. "3x8min VO2") combined '
                + 'with RPE and notes, rather than claiming precise per-interval numbers you don\'t have.')
